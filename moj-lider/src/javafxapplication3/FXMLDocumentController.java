        ...
        try {
            ...
            if(count>0) {
              ...
              Integer r = rs.getInt("Idrangi");
                ...
                String konto = "panelAdmin.fxml";
                 if(r!=null) {
                switch(r) {
                case  1: konto = "panelPracownik.fxml";break;
                case  2: konto =   "panelKierownik.fxml";break;
                default:  konto = "panelDyrektor.fxml";break;
                }
                }
                ...
                new Alert(Alert.AlertType.ERROR, "NIe udalo się zalogowac").show();
            }
